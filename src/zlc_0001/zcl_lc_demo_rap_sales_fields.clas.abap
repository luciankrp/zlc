CLASS zcl_lc_demo_rap_sales_fields DEFINITION
  PUBLIC
...
CLASS zcl_lc_demo_rap_sales_fields IMPLEMENTATION.
  METHOD main.
    ...
    DATA(config) = VALUE zif_gen_objects=>ddic_configuration( prefix            = 'ZLC_DEMO_SA_'
                                                              domains           = domains
